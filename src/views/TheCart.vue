  ...
  <main class="main">
    ...
    <div v-if="cartProducts.length > 0" class="cart">
      ...
      <aside class="cart__summary">
        ...
        <button type="button" class="cart__button" @click="open = true">Перейти к оформлению</button>
      </aside>
    </div>
    <p v-else >Ваша корзина пуста</p>
  </main>

  <OrderConfirm v-model:open="open" :cart="cartProducts" :cost="cartSum" @order-confirmed="clearCart"/>
</template>
